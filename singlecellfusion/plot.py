...
def get_random_colors(n):
    ...
    "#D16100", "#000035", "#7B4F4B", "#A1C299", "#300018", "#0AA6D8", "#013349", 
    "#00846F", "#372101", "#FFB500", "#A079BF", "#CC0744", "#C0B9B2", "#001E09",
...
def plot_scatter(df_plot,
    ...
    Args:
        ...
        legend_labels (str): Optional, column in df_plot containing labels for legend
...
def scatter_cluster(loom_file,
    ...
    Args:
        ...
        clust_attr (str): Attribute in loom_file specifying cluster IDs
        color_attr (str): Optional, attribute specifying colors to plot (per cell)
...
def percentile_norm(counts,
    ...
    normalized = [set_value_by_percentile(i,low_p,high_p) for i in list(counts)]
...
def scatter_feature(loom_file,
    ...
    with loompy.connect(loom_file) as ds:
        ...
        counts = np.ravel(ds.layers[layer][feat_idx,:][:,col_idx].astype(float)) 
