...
def calculate_mcc(loom_file,
    ...
    Args:
        ...
        mean_impute (bool): Replace missing mC/C values with mean across population
        ...
        batch_size (int): Chunk size
            Will load dense array of number of features by batch_size into memory
    ...
    with loompy.connect(loom_file) as ds:
        for layer in layers:
            if not layer in ds.layers.keys():
